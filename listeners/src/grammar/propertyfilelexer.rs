...
impl<'input, Input:CharStream<From<'input> >> TokenSource<'input> for PropertyFileLexer<'input,Input>{
    ...
    fn get_dfa_string(&self) -> String {
		...
		static ref _serializedATN: Vec<i32> = vec![
			...
			3, 1, 0, 0, 0, 0, 5, 1, 0, 0, 0, 0, 7, 1, 0, 0, 0, 1, 9, 1, 0, 0, 0, 
			3, 11, 1, 0, 0, 0, 5, 14, 1, 0, 0, 0, 7, 18, 1, 0, 0, 0, 9, 10, 5, 61, 
			0, 0, 10, 2, 1, 0, 0, 0, 11, 12, 5, 10, 0, 0, 12, 4, 1, 0, 0, 0, 13, 
			15, 7, 0, 0, 0, 14, 13, 1, 0, 0, 0, 15, 16, 1, 0, 0, 0, 16, 14, 1, 0, 
			0, 0, 16, 17, 1, 0, 0, 0, 17, 6, 1, 0, 0, 0, 18, 22, 5, 34, 0, 0, 19, 
			21, 9, 0, 0, 0, 20, 19, 1, 0, 0, 0, 21, 24, 1, 0, 0, 0, 22, 23, 1, 0, 
			0, 0, 22, 20, 1, 0, 0, 0, 23, 25, 1, 0, 0, 0, 24, 22, 1, 0, 0, 0, 25, 
			26, 5, 34, 0, 0, 26, 8, 1, 0, 0, 0, 3, 0, 16, 22, 0
		];
	}