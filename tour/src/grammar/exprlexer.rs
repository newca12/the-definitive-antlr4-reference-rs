...
impl<'input, Input:CharStream<From<'input> >> TokenSource<'input> for ExprLexer<'input,Input>{
    ...
    fn get_dfa_string(&self) -> String {
		...
		static ref _serializedATN: Vec<i32> = vec![
			...
			0, 0, 23, 24, 5, 61, 0, 0, 24, 2, 1, 0, 0, 0, 25, 26, 5, 42, 0, 0, 26, 
			4, 1, 0, 0, 0, 27, 28, 5, 47, 0, 0, 28, 6, 1, 0, 0, 0, 29, 30, 5, 43, 
			0, 0, 30, 8, 1, 0, 0, 0, 31, 32, 5, 45, 0, 0, 32, 10, 1, 0, 0, 0, 33, 
			34, 5, 40, 0, 0, 34, 12, 1, 0, 0, 0, 35, 36, 5, 41, 0, 0, 36, 14, 1, 
